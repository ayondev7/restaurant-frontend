...
const HeroSection: React.FC = () => {
  ...
  const handlePlateClick = (index: number) => {
    ...
    if (!validTransitions.some(([from, to]) => 
      from === activeIndex && to === index
    )) return;
  ...
  return (
    <section
      ref={sectionRef}
      className="min-h-screen relative px-6 py-12 overflow-hidden"
    >
      <div
        ref={circleRef}
      ...
      <div className="container mx-auto flex items-center justify-between flex-wrap md:flex-nowrap relative z-10 h-full">
        <div className="md:w-1/2 w-full space-y-8">
          <h1 className="text-5xl md:text-6xl font-bold text-white">BREAKFAST</h1>
