    ...
    <footer className="bg-[#880808] text-white">
      <div className="w-full px-2 md:px-48 py-12 flex flex-col gap-y-6 md:gap-y-0 md:flex-row md:justify-between">
        ...
        <div>
          ...
          <p className="flex text-sm md:text-base items-center mb-2">
          ...
          <p className="flex text-sm md:text-base items-center">
        ...
        <div>
          ...
          <ul className="space-y-2 grid grid-cols-4 md:grid-rows-4 md:grid-cols-1">
            <li><a href="#" className="hover:underline text-sm md:text-base">About us</a></li>
            <li><a href="#" className="hover:underline text-sm md:text-base">Contact Us</a></li>
            <li><a href="#" className="hover:underline text-sm md:text-base">Our Menu</a></li>
            <li><a href="#" className="hover:underline text-sm md:text-base">Team</a></li>
            <li><a href="#" className="hover:underline text-sm md:text-base">FAQ</a></li>
          </ul>
        </div>

        <div>
          <h2 className="text-xl font-semibold mb-4 hidden md:block">Instagram Gallery</h2>
