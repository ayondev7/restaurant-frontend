...
const Footer = () => {
    ...
    <footer className="bg-[#880808] text-white font-poppins">
      <div className="w-full px-2 md:px-48 px-4 pt-8 md:py-12 flex flex-col gap-y-6 md:gap-y-0 md:flex-row md:justify-between">
        <div className="mb-4 md:mb-0">
          <h2 className="text-2xl font-bold mb-4">RESTAURIO</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 gap-x-2 grid grid-cols-4 md:grid-rows-4 md:grid-cols-1 text-sm md:text-lg">
            <li>
  ...
  <p className="mb-2 md:mb-0 text-xs md:text-base">Copyright © 2025 Restaurio. All rights reserved</p>
